...
products.forEach((product) => {
  ...
  // Create a new div element to append the product HTML
  ...
  productElement.innerHTML = `
    ...
    <div class="product-rating-container">
      <img class="product-rating-stars" src="images/ratings/rating-${newStr}.png">
  ...
  // Append the created element to the products grid
